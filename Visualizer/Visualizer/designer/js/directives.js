...
app.directive('mvcvalidate', function() {
	return {
		restrict : 'A',
	...
	return {
		...
		link : function(scope, elem, attrs) {
			...
			elem.on('click', function(evt) {
				...
				$('.mvc_bubble_autocomplete.active').removeClass('.mvc_bubble_autocomplete active').addClass('.mvc_bubble_autocomplete');
			});
	...
	return {
		...
		link : function(scope, element, attrs, ngModel) {
			...
			ngModel.$formatters.push(function(value) {
				return $filter('currency')(value, attrs['mvc-currency'] );
			});
...
app.directive('mvcDatePicker', function() {

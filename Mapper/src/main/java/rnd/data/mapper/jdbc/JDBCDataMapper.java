...
public class JDBCDataMapper extends AbstractDataProcessor<JDBCInfo, JDBCResponsePayLoad> {

	@Override
	public String processRequest(JDBCInfo jdbcInfo, DataProcessorCallback callback) throws Throwable {

		if (callback != null) {
			callback.processCallback(new JDBCDataMapperCallbackContext(jdbcInfo, null));
		}
	...
	public Object processResponse(Object responseXML, JDBCInfo jdbcInfo, JDBCResponsePayLoad jdbcResponsePayLoad, DataProcessorCallback callback) throws Throwable {
		...
		if (callback != null) {
			callback.processCallback(new JDBCDataMapperCallbackContext(jdbcInfo, jdbcResponsePayLoad));
		}
